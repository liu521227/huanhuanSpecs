...
@implementation NSDate (PPDBLHelper)
...
#endif
    NSDateComponents *components1 = [[NSDate currentCalendar] components:unitFlags fromDate:self];
    NSDateComponents *components2 = [[NSDate currentCalendar] components:unitFlags fromDate:aDate];
...
#endif
    NSDateComponents *components1 = [[NSDate currentCalendar] components:unitFlags fromDate:self];
    NSDateComponents *components2 = [[NSDate currentCalendar] components:unitFlags fromDate:[NSDate date]];
...
- (NSInteger) nearestHour {
    ...
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
    NSDateComponents *components = [[NSDate currentCalendar] components:unitFlags fromDate:newDate];
